    ...
    <div className="flex flex-col lg:flex-row gap-6 pb-8">
      ...
      <main className="flex-1 min-w-0 space-y-6">
        ...
        <p className="text-xs text-muted-foreground pb-2">
          Note: These projections model CPA compounding when Audience Saturation is above 0%. Other factors — finite addressable market size, churn eventually matching acquisition at scale — are not modeled. The numbers are most reliable in the early months.
        </p>
      </main>
    </div>
    </div>
